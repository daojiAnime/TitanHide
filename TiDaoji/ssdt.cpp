...
PVOID SSDT::GetFunctionAddress(const char* apiname)
{
    ...
    if(!SSDT)
    {
        Log("[TIDAOJI] SSDT not found...\r\n");
        return 0;
    }
    ULONG_PTR SSDTbase = (ULONG_PTR)SSDT->pServiceTable;
    if(!SSDTbase)
    {
        Log("[TIDAOJI] ServiceTable not found...\r\n");
        return 0;
    }
    ...
    {
        Log("[TIDAOJI] Invalid read offset...\r\n");
        return 0;
    }
#ifdef _WIN64
...
HOOK SSDT::Hook(const char* apiname, void* newfunc)
{
    ...
    {
        Log("[TIDAOJI] Invalid API offset...\r\n");
        return 0;
    }
    ...
    */
    ...
    if(!CaveAddress)
    {
        Log("[TIDAOJI] FindCaveAddress failed...\r\n");
        return 0;
    }
    Log("[TIDAOJI] CaveAddress: 0x%p\r\n", CaveAddress);
