...
ULONG PE::GetExportOffset(const unsigned char* FileData, ULONG FileSize, const char* ExportName)
{
    ...
    {
        Log("[TIDAOJI] Invalid IMAGE_DOS_SIGNATURE!\r\n");
        return PE_ERROR_VALUE;
    }
    ...
    {
        Log("[TIDAOJI] Invalid IMAGE_NT_SIGNATURE!\r\n");
        return PE_ERROR_VALUE;
    }
    ...
    {
        Log("[TIDAOJI] Invalid Export Directory!\r\n");
        return PE_ERROR_VALUE;
    }
    ...
    {
        Log("[TIDAOJI] Invalid Export Directory Contents!\r\n");
        return PE_ERROR_VALUE;
    }
    ...
    {
        Log("[TIDAOJI] Export %s not found in export table!\r\n", ExportName);
    }
